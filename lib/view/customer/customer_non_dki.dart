...
class ListCustomerNonDki extends StatefulWidget {
  const ListCustomerNonDki({Key? key}) : super(key: key);

  @override
  State<ListCustomerNonDki> createState() => _ListCustomerNonDkiState();
}

class _ListCustomerNonDkiState extends State<ListCustomerNonDki> {
  @override
  void initState() {
                                                            ...
                                                            children: [
                                                              ...
                                                              ListTile(
                                                                ...
                                                                subtitle: Text(
                                                                  list.listSearch
                                                                          .isEmpty
                                                                      ? list.listRecords[index]['provinsi'] == null ||
                                                                              list.listRecords[index]['provinsi'] ==
                                                                                  ''
                                                                          ? 'Tidak ada data'
                                                                          : '${list.listRecords[index]['provinsi']['prov_name']}'
                                                                      : list.listSearch[index]['provinsi'] == null ||
                                                                              list.listSearch[index]['provinsi'] == ''
                                                                          ? 'Tidak ada data'
                                                                          : '${list.listSearch[index]['provinsi']['prov_name']}',
                                                                  maxLines: 2,
                                                                  overflow:
                                                                      TextOverflow
                                                                          .ellipsis,
                                                                ...
                                                                subtitle:
                                                                  ...
                                                                  children: [
                                                                    Text(
                                                                      list.listSearch
                                                                              .isEmpty
                                                                          ? list.listRecords[index]['kota'] == null || list.listRecords[index]['kota'] == ''
                                                                              ? 'Tidak ada data'
                                                                              : '${list.listRecords[index]['kota']['city_name']}'
                                                                          : list.listSearch[index]['kota'] == null || list.listSearch[index]['kota'] == ''
                                                                              ? 'Tidak ada data'
                                                                              : '${list.listSearch[index]['kota']['city_name']}',
                                                                      maxLines:
                                                                          2,
                                                                      overflow:
                                                                          TextOverflow
                                                              ...
                                                              ListTile(
                                                                ...
                                                                subtitle: Text(
                                                                  list.listSearch
                                                                          .isEmpty
                                                                      ? list.listRecords[index]['kelurahan'] == null ||
                                                                              list.listRecords[index]['kelurahan'] ==
                                                                                  ''
                                                                          ? 'Tidak ada data'
                                                                          : '${list.listRecords[index]['kelurahan']['subdis_name']}'
                                                                      : list.listSearch[index]['kelurahan'] == null ||
                                                                              list.listSearch[index]['kelurahan'] == ''
                                                                          ? 'Tidak ada data'
                                                                          : '${list.listSearch[index]['kelurahan']['subdis_name']}',
                                                                  maxLines: 2,
                                                                  overflow:
                                                                      TextOverflow
                                                                          .ellipsis,
                                                              ...
                                                              ListTile(
                                                                ...
                                                                subtitle: Text(
                                                                  list.listSearch
                                                                          .isEmpty
                                                                      ? list.listRecords[index]['kecamatan'] == null ||
                                                                              list.listRecords[index]['kecamatan'] ==
                                                                                  ''
                                                                          ? 'Tidak ada data'
                                                                          : '${list.listRecords[index]['kecamatan']['dis_name']}'
                                                                      : list.listSearch[index]['kecamatan'] == null ||
                                                                              list.listSearch[index]['kecamatan'] == ''
                                                                          ? 'Tidak ada data'
                                                                          : '${list.listSearch[index]['kecamatan']['dis_name']}',
                                                                  maxLines: 2,
                                                                  overflow:
                                                                      TextOverflow
                                                                          .ellipsis,
