...
class AkunNonDki extends StatefulWidget {
  const AkunNonDki({
    Key? key,
  }) : super(key: key);
  ...
  _AkunNonDkiState createState() => _AkunNonDkiState();
}

class _AkunNonDkiState extends State<AkunNonDki> {
  @override
  void initState() {
                              ...
                              child: CircleAvatar(
                                ...
                                child: home.fotoProfile.value == ''
                                    ...
                                    : CachedNetworkImage(
                                        ...
                                        imageUrl:
                                            urlFoto2 + home.fotoProfile.value,
                                        imageBuilder:
